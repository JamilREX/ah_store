...
class HomeController extends GetxController {
  ...
  getCategories()async{
    ...
    loading.value = true;
    http.Response response =await RequestHelper.get(url: KConstants.domain +  'api/category/all');
    if(response.statusCode==200){
      categoryModelList = CategoryModelReq.fromJson(jsonDecode(response.body)).categoryModel!;
