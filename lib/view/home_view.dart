                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CarouselSlider(
                        ...
                        items: controller.topProducts.map((product) => InkWell(onTap: (){Get.to(ProductDetailsView(product: product));},child: Image.network(KConstants.domain+product.photo.toString()))).toList(),
                      ),
                      Neumorphic(
                      ...
                      controller.homeCategoryModelList.isNotEmpty
                          ? GridView.builder(
                              shrinkWrap: true,
                              physics: const NeverScrollableScrollPhysics(),
                              itemCount:
                                  controller.homeCategoryModelList.length,
                              itemBuilder: (context, index) {
                                return CategoryCard(
                                    fullCategory:
                                        controller.homeCategoryModelList[index],
                                    fullCategoryIndex: index);
                              },
                              gridDelegate:
